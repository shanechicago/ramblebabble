...
export const TONES: Option[] = [
  ...
  { id: "blunt", label: "Blunt / No-BS", hint: "Brutally honest", instruction: "Use a blunt, no-BS tone: brutally honest, zero sugarcoating, straight to the hard truth in as few words as possible. Direct and unsparing, but aimed at the situation, not cruel to a person." },
