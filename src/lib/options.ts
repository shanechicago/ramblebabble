...
export const TONES: Option[] = [
  ...
  { id: "seductive", label: "Seductive", hint: "Smooth and irresistible", instruction: "Use a smooth, confident, irresistibly seductive tone: magnetic, self-assured, and tempting, charming the reader into wanting more with every word, each line a slow, knowing invitation. Pure allure and command, dripping with quiet heat. Suggestive and evocative, never timid." },
  { id: "steamy", label: "Steamy", hint: "Full erotic heat", instruction: "Use a full-heat, steamy, passionately erotic tone, the hottest adult-romance register: intense desire, breathless tension, charged physical longing, sensual detail, want laced through every line. Lean ALL the way into the heat and the eroticism, never tame it, while staying suggestive and evocative rather than graphically explicit." },
  { id: "naughty", label: "Naughty", hint: "Playful and dirty-minded", instruction: "Use a playful, naughty, dirty-minded tone: cheeky, teasing, shameless, packed with suggestive double entendres and wink-wink innuendo, a little filthy and a lot of fun. Bold and unapologetic, suggestive rather than graphic." },
...
export const ACCENTS: Option[] = [
  ...
  { id: "millennial", label: "Millennial", hint: "Adulting is hard", instruction: "Give it a self-aware, ironic Millennial voice: 'adulting', 'I can't even', 'living my best life', 'it me', 'big mood', 'literally dying', 'treat yourself', 'send help'. Anxious-but-funny, burned out, fueled by coffee and nostalgia for the early 2000s. Earnest under the irony." },
  { id: "genx", label: "Gen X", hint: "Whatever, slacker cool", instruction: "Give it a dry, unbothered Gen X voice: sarcastic, skeptical, allergic to hype, '90s slacker cool. 'Whatever', 'as if', 'meh', eye-rolling at everything, low-key cynical, self-reliant, with a wink about being the forgotten middle-child generation." },
