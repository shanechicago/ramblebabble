...
export const OUTPUT_TYPES: Option[] = [
  // ===== Useful =====
  { id: "note", label: "Cleaned note", hint: "Tidy, readable version", example: "Your words tidied into a clear, readable note.", instruction: "Rewrite as a clean, well-structured note. Keep all the substance, remove filler and repetition, organize into short paragraphs or bullets where it helps readability. Do NOT format it as an email or message: no 'Subject:' line, no greeting, and no sign-off. It is a standalone note." },
