...
export const ACCENTS: Option[] = [
  ...
  { id: "pirate", label: "Pirate", hint: "Arr, matey", instruction: "Give it swashbuckling pirate speech at FULL BLAST, built on pirate GRAMMAR: 'be' for is/are, 'me' for my, 'ye' for you, 'yer' for your, dropped g's. Lay the pirate talk on THICK: 'arr', 'avast', 'ahoy', 'matey', 'shiver me timbers', 'ye scurvy landlubber', 'walk the plank'. Drench every line in pirate, while still telling one clear message a reader can follow." },
