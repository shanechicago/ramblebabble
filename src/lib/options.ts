...
export const OUTPUT_TYPES: Option[] = [
  ...
  { id: "conversational", label: "Conversational", hint: "Just say it, plainly", example: "Just say it. No structure, no sections, no outline. Your point, clearly, the way you'd actually say it.", instruction: "Rewrite as flowing, natural conversational prose, the way a real person would actually say it out loud. Understand their point, consolidate the repetition, and reorganize the scattered thoughts so it is clear and easy to follow. Then deliver it as plain flowing prose ONLY. Under NO circumstances impose structure: no labeled sections, no headers, no bullet points, no numbered lists, no outline, no executive-summary framing. One clear through-line, said once, in their own natural first-person voice. No subject line, no greeting, no sign-off." },
